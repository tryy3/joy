...
func (*MSStreamReader) ReadAsArrayBuffer(stream *ms.MSStream, size *int64) {
	macro.Rewrite("$_.readAsArrayBuffer($1, $2)", stream, size)
}

// ReadAsBinaryString fn
// js:"readAsBinaryString"
func (*MSStreamReader) ReadAsBinaryString(stream *ms.MSStream, size *int64) {
	macro.Rewrite("$_.readAsBinaryString($1, $2)", stream, size)
}

// ReadAsBlob fn
// js:"readAsBlob"
func (*MSStreamReader) ReadAsBlob(stream *ms.MSStream, size *int64) {
	macro.Rewrite("$_.readAsBlob($1, $2)", stream, size)
}

// ReadAsDataURL fn
// js:"readAsDataURL"
func (*MSStreamReader) ReadAsDataURL(stream *ms.MSStream, size *int64) {
	macro.Rewrite("$_.readAsDataURL($1, $2)", stream, size)
}

// ReadAsText fn
// js:"readAsText"
func (*MSStreamReader) ReadAsText(stream *ms.MSStream, encoding *string, size *int64) {
