...
import (
	...
	"github.com/matthewmueller/joy/dom/xhr"
...
// ResponseType prop
// js:"responseType"
func (*XMLHTTPRequest) ResponseType() (responseType *xhr.XMLHTTPRequestResponseType) {
...
// js:"responseType"
func (*XMLHTTPRequest) SetResponseType(responseType *xhr.XMLHTTPRequestResponseType) {
