...
type AudioContext interface {
	...
	CreateBuffer(numberOfChannels uint, length uint, sampleRate float32) (a *audio.AudioBuffer)
	...
	CreatePeriodicWave(rl []float32, img []float32, constraints *audio.PeriodicWaveConstraints) (a *audio.PeriodicWave)
	...
	DecodeAudioData(audioData []byte, successCallback *func(decodedData *audio.AudioBuffer), errorCallback *func()) (a *audio.AudioBuffer)
	...
	Listener() (listener *audio.AudioListener)
	...
	// js:"state"
	// jsrewrite:"$_.state"
	State() (state *audio.AudioContextState)
}
