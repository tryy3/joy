...
// js:"channelCountMode"
func (*IIRFilterNode) ChannelCountMode() (channelCountMode *audio.ChannelCountMode) {
...
// js:"channelCountMode"
func (*IIRFilterNode) SetChannelCountMode(channelCountMode *audio.ChannelCountMode) {
	macro.Rewrite("$_.channelCountMode = $1", channelCountMode)
}

// ChannelInterpretation prop
// js:"channelInterpretation"
func (*IIRFilterNode) ChannelInterpretation() (channelInterpretation *audio.ChannelInterpretation) {
...
// js:"channelInterpretation"
func (*IIRFilterNode) SetChannelInterpretation(channelInterpretation *audio.ChannelInterpretation) {
