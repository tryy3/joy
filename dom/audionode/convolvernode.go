...
// Buffer prop
// js:"buffer"
func (*ConvolverNode) Buffer() (buffer *audio.AudioBuffer) {
...
// SetBuffer prop
// js:"buffer"
func (*ConvolverNode) SetBuffer(buffer *audio.AudioBuffer) {
...
// js:"channelCountMode"
func (*ConvolverNode) ChannelCountMode() (channelCountMode *audio.ChannelCountMode) {
...
// js:"channelCountMode"
func (*ConvolverNode) SetChannelCountMode(channelCountMode *audio.ChannelCountMode) {
	macro.Rewrite("$_.channelCountMode = $1", channelCountMode)
}

// ChannelInterpretation prop
// js:"channelInterpretation"
func (*ConvolverNode) ChannelInterpretation() (channelInterpretation *audio.ChannelInterpretation) {
...
// js:"channelInterpretation"
func (*ConvolverNode) SetChannelInterpretation(channelInterpretation *audio.ChannelInterpretation) {
