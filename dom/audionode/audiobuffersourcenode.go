...
// Buffer prop
// js:"buffer"
func (*AudioBufferSourceNode) Buffer() (buffer *audio.AudioBuffer) {
...
// SetBuffer prop
// js:"buffer"
func (*AudioBufferSourceNode) SetBuffer(buffer *audio.AudioBuffer) {
...
// js:"channelCountMode"
func (*AudioBufferSourceNode) ChannelCountMode() (channelCountMode *audio.ChannelCountMode) {
...
// js:"channelCountMode"
func (*AudioBufferSourceNode) SetChannelCountMode(channelCountMode *audio.ChannelCountMode) {
	macro.Rewrite("$_.channelCountMode = $1", channelCountMode)
}

// ChannelInterpretation prop
// js:"channelInterpretation"
func (*AudioBufferSourceNode) ChannelInterpretation() (channelInterpretation *audio.ChannelInterpretation) {
...
// js:"channelInterpretation"
func (*AudioBufferSourceNode) SetChannelInterpretation(channelInterpretation *audio.ChannelInterpretation) {
