...
// js:"channelCountMode"
func (*ChannelMergerNode) ChannelCountMode() (channelCountMode *audio.ChannelCountMode) {
...
// js:"channelCountMode"
func (*ChannelMergerNode) SetChannelCountMode(channelCountMode *audio.ChannelCountMode) {
	macro.Rewrite("$_.channelCountMode = $1", channelCountMode)
}

// ChannelInterpretation prop
// js:"channelInterpretation"
func (*ChannelMergerNode) ChannelInterpretation() (channelInterpretation *audio.ChannelInterpretation) {
...
// js:"channelInterpretation"
func (*ChannelMergerNode) SetChannelInterpretation(channelInterpretation *audio.ChannelInterpretation) {
