...
// DistanceModel prop
// js:"distanceModel"
func (*PannerNode) DistanceModel() (distanceModel *audio.DistanceModelType) {
...
// js:"distanceModel"
func (*PannerNode) SetDistanceModel(distanceModel *audio.DistanceModelType) {
...
// PanningModel prop
// js:"panningModel"
func (*PannerNode) PanningModel() (panningModel *audio.PanningModelType) {
...
// js:"panningModel"
func (*PannerNode) SetPanningModel(panningModel *audio.PanningModelType) {
...
// js:"channelCountMode"
func (*PannerNode) ChannelCountMode() (channelCountMode *audio.ChannelCountMode) {
...
// js:"channelCountMode"
func (*PannerNode) SetChannelCountMode(channelCountMode *audio.ChannelCountMode) {
	macro.Rewrite("$_.channelCountMode = $1", channelCountMode)
}

// ChannelInterpretation prop
// js:"channelInterpretation"
func (*PannerNode) ChannelInterpretation() (channelInterpretation *audio.ChannelInterpretation) {
...
// js:"channelInterpretation"
func (*PannerNode) SetChannelInterpretation(channelInterpretation *audio.ChannelInterpretation) {
