...
// SetPeriodicWave fn
// js:"setPeriodicWave"
func (*OscillatorNode) SetPeriodicWave(periodicWave *audio.PeriodicWave) {
...
// Type prop
// js:"type"
func (*OscillatorNode) Type() (kind *audio.OscillatorType) {
...
// SetType prop
// js:"type"
func (*OscillatorNode) SetType(kind *audio.OscillatorType) {
...
// js:"channelCountMode"
func (*OscillatorNode) ChannelCountMode() (channelCountMode *audio.ChannelCountMode) {
...
// js:"channelCountMode"
func (*OscillatorNode) SetChannelCountMode(channelCountMode *audio.ChannelCountMode) {
	macro.Rewrite("$_.channelCountMode = $1", channelCountMode)
}

// ChannelInterpretation prop
// js:"channelInterpretation"
func (*OscillatorNode) ChannelInterpretation() (channelInterpretation *audio.ChannelInterpretation) {
...
// js:"channelInterpretation"
func (*OscillatorNode) SetChannelInterpretation(channelInterpretation *audio.ChannelInterpretation) {
