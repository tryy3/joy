...
// Oversample prop
// js:"oversample"
func (*WaveShaperNode) Oversample() (oversample *audio.OverSampleType) {
...
// SetOversample prop
// js:"oversample"
func (*WaveShaperNode) SetOversample(oversample *audio.OverSampleType) {
...
// js:"channelCountMode"
func (*WaveShaperNode) ChannelCountMode() (channelCountMode *audio.ChannelCountMode) {
...
// js:"channelCountMode"
func (*WaveShaperNode) SetChannelCountMode(channelCountMode *audio.ChannelCountMode) {
	macro.Rewrite("$_.channelCountMode = $1", channelCountMode)
}

// ChannelInterpretation prop
// js:"channelInterpretation"
func (*WaveShaperNode) ChannelInterpretation() (channelInterpretation *audio.ChannelInterpretation) {
...
// js:"channelInterpretation"
func (*WaveShaperNode) SetChannelInterpretation(channelInterpretation *audio.ChannelInterpretation) {
