...
// js:"channelCountMode"
func (*ChannelSplitterNode) ChannelCountMode() (channelCountMode *audio.ChannelCountMode) {
...
// js:"channelCountMode"
func (*ChannelSplitterNode) SetChannelCountMode(channelCountMode *audio.ChannelCountMode) {
	macro.Rewrite("$_.channelCountMode = $1", channelCountMode)
}

// ChannelInterpretation prop
// js:"channelInterpretation"
func (*ChannelSplitterNode) ChannelInterpretation() (channelInterpretation *audio.ChannelInterpretation) {
...
// js:"channelInterpretation"
func (*ChannelSplitterNode) SetChannelInterpretation(channelInterpretation *audio.ChannelInterpretation) {
