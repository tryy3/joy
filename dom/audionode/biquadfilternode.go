...
// Type prop
// js:"type"
func (*BiquadFilterNode) Type() (kind *audio.BiquadFilterType) {
...
// SetType prop
// js:"type"
func (*BiquadFilterNode) SetType(kind *audio.BiquadFilterType) {
...
// js:"channelCountMode"
func (*BiquadFilterNode) ChannelCountMode() (channelCountMode *audio.ChannelCountMode) {
...
// js:"channelCountMode"
func (*BiquadFilterNode) SetChannelCountMode(channelCountMode *audio.ChannelCountMode) {
	macro.Rewrite("$_.channelCountMode = $1", channelCountMode)
}

// ChannelInterpretation prop
// js:"channelInterpretation"
func (*BiquadFilterNode) ChannelInterpretation() (channelInterpretation *audio.ChannelInterpretation) {
...
// js:"channelInterpretation"
func (*BiquadFilterNode) SetChannelInterpretation(channelInterpretation *audio.ChannelInterpretation) {
