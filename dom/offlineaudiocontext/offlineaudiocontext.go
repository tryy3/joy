...
// StartRendering fn
// js:"startRendering"
func (*OfflineAudioContext) StartRendering() (a *audio.AudioBuffer) {
...
// CreateBuffer fn
// js:"createBuffer"
func (*OfflineAudioContext) CreateBuffer(numberOfChannels uint, length uint, sampleRate float32) (a *audio.AudioBuffer) {
...
func (*OfflineAudioContext) CreatePeriodicWave(rl []float32, img []float32, constraints *audio.PeriodicWaveConstraints) (a *audio.PeriodicWave) {
...
// DecodeAudioData fn
// js:"decodeAudioData"
func (*OfflineAudioContext) DecodeAudioData(audioData []byte, successCallback *func(decodedData *audio.AudioBuffer), errorCallback *func()) (a *audio.AudioBuffer) {
...
// Listener prop
// js:"listener"
func (*OfflineAudioContext) Listener() (listener *audio.AudioListener) {
...
// State prop
// js:"state"
func (*OfflineAudioContext) State() (state *audio.AudioContextState) {
