...
// New fn
func New(methoddata []*payment.PaymentMethodData, details *paymentdetails.PaymentDetails, options *payment.PaymentOptions) *PaymentRequest {
...
// Show fn
// js:"show"
func (*PaymentRequest) Show() (p *payment.PaymentResponse) {
...
// js:"shippingAddress"
func (*PaymentRequest) ShippingAddress() (shippingAddress *payment.PaymentAddress) {
...
// ShippingType prop
// js:"shippingType"
func (*PaymentRequest) ShippingType() (shippingType *payment.PaymentShippingType) {
