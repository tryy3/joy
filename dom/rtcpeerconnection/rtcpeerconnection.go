...
type RTCPeerConnection interface {
	...
	AddIceCandidate(candidate *webrtc.RTCIceCandidate, successCallback *func(), failureCallback *func(err *dom.DOMError))
	...
	CreateAnswer(successCallback *func(sdp *rtcsessiondescription.RTCSessionDescription), failureCallback *func(err *dom.DOMError)) (r *rtcsessiondescription.RTCSessionDescription)

	// CreateOffer
	// js:"createOffer"
	// jsrewrite:"await $_.createOffer($1, $2, $3)"
	CreateOffer(successCallback *func(sdp *rtcsessiondescription.RTCSessionDescription), failureCallback *func(err *dom.DOMError), options *webrtc.RTCOfferOptions) (r *rtcsessiondescription.RTCSessionDescription)

	// GetConfiguration
	// js:"getConfiguration"
	// jsrewrite:"$_.getConfiguration()"
	GetConfiguration() (w *webrtc.RTCConfiguration)
	...
	GetStats(selector *window.MediaStreamTrack, successCallback *func(report *webrtc.RTCStatsReport), failureCallback *func(err *dom.DOMError)) (w *webrtc.RTCStatsReport)
	...
	SetLocalDescription(description *rtcsessiondescription.RTCSessionDescription, successCallback *func(), failureCallback *func(err *dom.DOMError))

	// SetRemoteDescription
	// js:"setRemoteDescription"
	// jsrewrite:"await $_.setRemoteDescription($1, $2, $3)"
	SetRemoteDescription(description *rtcsessiondescription.RTCSessionDescription, successCallback *func(), failureCallback *func(err *dom.DOMError))
	...
	IceConnectionState() (iceConnectionState *webrtc.RTCIceConnectionState)

	// IceGatheringState prop
	// js:"iceGatheringState"
	// jsrewrite:"$_.iceGatheringState"
	IceGatheringState() (iceGatheringState *webrtc.RTCIceGatheringState)
	...
	SignalingState() (signalingState *webrtc.RTCSignalingState)
}
