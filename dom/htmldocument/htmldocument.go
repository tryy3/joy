...
// CreateExpression fn
// js:"createExpression"
func (*HTMLDocument) CreateExpression(expression string, resolver *utils.XPathNSResolver) (w *window.XPathExpression) {
...
// CreateNSResolver fn
// js:"createNSResolver"
func (*HTMLDocument) CreateNSResolver(nodeResolver window.Node) (u *utils.XPathNSResolver) {
...
// Evaluate fn
// js:"evaluate"
func (*HTMLDocument) Evaluate(expression string, contextNode window.Node, resolver *utils.XPathNSResolver, kind uint8, result *window.XPathResult) (w *window.XPathResult) {
...
// js:"all"
func (*HTMLDocument) All() (all *html.HTMLAllCollection) {
	macro.Rewrite("$_.all")
	return all
}
