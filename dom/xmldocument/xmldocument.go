...
// CreateExpression fn
// js:"createExpression"
func (*XMLDocument) CreateExpression(expression string, resolver *utils.XPathNSResolver) (w *window.XPathExpression) {
...
// CreateNSResolver fn
// js:"createNSResolver"
func (*XMLDocument) CreateNSResolver(nodeResolver window.Node) (u *utils.XPathNSResolver) {
...
// Evaluate fn
// js:"evaluate"
func (*XMLDocument) Evaluate(expression string, contextNode window.Node, resolver *utils.XPathNSResolver, kind uint8, result *window.XPathResult) (w *window.XPathResult) {
