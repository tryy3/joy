...
// MakeCredential fn
// js:"makeCredential"
func (*WebAuthentication) MakeCredential(accountInformation *authentication.Account, cryptoParameters []*authentication.ScopedCredentialParameters, attestationChallenge []byte, options *scopedcredentialoptions.ScopedCredentialOptions) (s *scopedcredentialinfo.ScopedCredentialInfo) {
