...
// CreateIndex fn
// js:"createIndex"
func (*IDBObjectStore) CreateIndex(name string, keyPath string, optionalParameters *indexdb.IDBIndexParameters) (i *IDBIndex) {
...
// OpenCursor fn
// js:"openCursor"
func (*IDBObjectStore) OpenCursor(rng *interface{}, direction *indexdb.IDBCursorDirection) (i IDBRequest) {
