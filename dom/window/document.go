...
type Document interface {
	...
	CreateExpression(expression string, resolver *utils.XPathNSResolver) (x *XPathExpression)
	...
	CreateNSResolver(nodeResolver Node) (u *utils.XPathNSResolver)
	...
	Evaluate(expression string, contextNode Node, resolver *utils.XPathNSResolver, kind uint8, result *XPathResult) (x *XPathResult)
	...
	VisibilityState() (visibilityState *document.VisibilityState)
