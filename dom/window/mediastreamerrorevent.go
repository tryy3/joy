...
func NewMediaStreamErrorEvent(typearg string, eventinitdict *mediastreams.MediaStreamErrorEventInit) *MediaStreamErrorEvent {
...
// Error prop
// js:"error"
func (*MediaStreamErrorEvent) Error() (err *mediastreams.MediaStreamError) {
