...
func (*IDBDatabase) CreateObjectStore(name string, optionalParameters *indexdb.IDBObjectStoreParameters) (i *IDBObjectStore) {
...
// Transaction fn
// js:"transaction"
func (*IDBDatabase) Transaction(storeNames interface{}, mode *indexdb.IDBTransactionMode) (i *IDBTransaction) {
