...
func (*Window) WebkitConvertPointFromNodeToPage(node Node, pt *webkit.WebKitPoint) (w *webkit.WebKitPoint) {
...
func (*Window) WebkitConvertPointFromPageToNode(node Node, pt *webkit.WebKitPoint) (w *webkit.WebKitPoint) {
...
// Fetch fn
// js:"fetch"
func (*Window) Fetch(input *request.Request, init *fetch.RequestInit) (r *response.Response) {
