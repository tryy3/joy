...
func (*Navigator) RequestMediaKeySystemAccess(keySystem string, supportedConfigurations []*eme.MediaKeySystemConfiguration) (m *MediaKeySystemAccess) {
...
// GetUserMedia fn
// js:"getUserMedia"
func (*Navigator) GetUserMedia(constraints *mediastreams.MediaStreamConstraints, successCallback func(stream *MediaStream), errorCallback func(err *mediastreams.MediaStreamError)) {
