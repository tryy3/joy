...
// NewNotification fn
func NewNotification(title string, options *notification.NotificationOptions) *Notification {
...
func (*Notification) RequestPermission(callback *func(permission *notification.NotificationPermission)) (n *notification.NotificationPermission) {
...
// Dir prop
// js:"dir"
func (*Notification) Dir() (dir *notification.NotificationDirection) {
	macro.Rewrite("$_.dir")
	return dir
}
...
// Permission prop
// js:"permission"
func (*Notification) Permission() (permission *notification.NotificationPermission) {
