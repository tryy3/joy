...
// GetNotifications fn
// js:"getNotifications"
func (*ServiceWorkerRegistration) GetNotifications(filter *serviceworker.GetNotificationOptions) (n []*Notification) {
...
// Sync prop
// js:"sync"
func (*ServiceWorkerRegistration) Sync() (sync *serviceworker.SyncManager) {
