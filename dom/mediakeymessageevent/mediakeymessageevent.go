...
// New fn
func New(kind string, eventinitdict *eme.MediaKeyMessageEventInit) *MediaKeyMessageEvent {
...
// MessageType prop
// js:"messageType"
func (*MediaKeyMessageEvent) MessageType() (messageType *eme.MediaKeyMessageType) {
