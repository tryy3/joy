...
// New fn
func New(transport *rtcicetransport.RTCIceTransport, encryptparameters *webrtc.RTCSrtpSdesParameters, decryptparameters *webrtc.RTCSrtpSdesParameters) *RTCSrtpSdesTransport {
...
func (*RTCSrtpSdesTransport) GetLocalParameters() (w []*webrtc.RTCSrtpSdesParameters) {
