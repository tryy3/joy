...
// CreateAnswer fn
// js:"createAnswer"
func (*WebkitRTCPeerConnection) CreateAnswer(successCallback *func(sdp *rtcsessiondescription.RTCSessionDescription), failureCallback *func(err *dom.DOMError)) (r *rtcsessiondescription.RTCSessionDescription) {
...
// CreateOffer fn
// js:"createOffer"
func (*WebkitRTCPeerConnection) CreateOffer(successCallback *func(sdp *rtcsessiondescription.RTCSessionDescription), failureCallback *func(err *dom.DOMError), options *webrtc.RTCOfferOptions) (r *rtcsessiondescription.RTCSessionDescription) {
...
// GetConfiguration fn
// js:"getConfiguration"
func (*WebkitRTCPeerConnection) GetConfiguration() (w *webrtc.RTCConfiguration) {
...
// GetStats fn
// js:"getStats"
func (*WebkitRTCPeerConnection) GetStats(selector *window.MediaStreamTrack, successCallback *func(report *webrtc.RTCStatsReport), failureCallback *func(err *dom.DOMError)) (w *webrtc.RTCStatsReport) {
...
func (*WebkitRTCPeerConnection) SetLocalDescription(description *rtcsessiondescription.RTCSessionDescription, successCallback *func(), failureCallback *func(err *dom.DOMError)) {
...
func (*WebkitRTCPeerConnection) SetRemoteDescription(description *rtcsessiondescription.RTCSessionDescription, successCallback *func(), failureCallback *func(err *dom.DOMError)) {
