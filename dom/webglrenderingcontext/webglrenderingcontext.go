...
import (
	...
	"github.com/matthewmueller/joy/dom/webgl"
...
// AttachShader fn
// js:"attachShader"
func (*WebGLRenderingContext) AttachShader(program *webgl.WebGLProgram, shader *webgl.WebGLShader) {
	macro.Rewrite("$_.attachShader($1, $2)", program, shader)
}

// BindAttribLocation fn
// js:"bindAttribLocation"
func (*WebGLRenderingContext) BindAttribLocation(program *webgl.WebGLProgram, index uint, name string) {
	macro.Rewrite("$_.bindAttribLocation($1, $2, $3)", program, index, name)
}

// BindBuffer fn
// js:"bindBuffer"
func (*WebGLRenderingContext) BindBuffer(target uint, buffer *webgl.WebGLBuffer) {
	macro.Rewrite("$_.bindBuffer($1, $2)", target, buffer)
}

// BindFramebuffer fn
// js:"bindFramebuffer"
func (*WebGLRenderingContext) BindFramebuffer(target uint, framebuffer *webgl.WebGLFramebuffer) {
	macro.Rewrite("$_.bindFramebuffer($1, $2)", target, framebuffer)
}

// BindRenderbuffer fn
// js:"bindRenderbuffer"
func (*WebGLRenderingContext) BindRenderbuffer(target uint, renderbuffer *webgl.WebGLRenderbuffer) {
	macro.Rewrite("$_.bindRenderbuffer($1, $2)", target, renderbuffer)
}

// BindTexture fn
// js:"bindTexture"
func (*WebGLRenderingContext) BindTexture(target uint, texture *webgl.WebGLTexture) {
...
// CompileShader fn
// js:"compileShader"
func (*WebGLRenderingContext) CompileShader(shader *webgl.WebGLShader) {
...
// CreateBuffer fn
// js:"createBuffer"
func (*WebGLRenderingContext) CreateBuffer() (w *webgl.WebGLBuffer) {
...
func (*WebGLRenderingContext) CreateFramebuffer() (w *webgl.WebGLFramebuffer) {
...
// CreateProgram fn
// js:"createProgram"
func (*WebGLRenderingContext) CreateProgram() (w *webgl.WebGLProgram) {
...
func (*WebGLRenderingContext) CreateRenderbuffer() (w *webgl.WebGLRenderbuffer) {
...
// CreateShader fn
// js:"createShader"
func (*WebGLRenderingContext) CreateShader(kind uint) (w *webgl.WebGLShader) {
...
// CreateTexture fn
// js:"createTexture"
func (*WebGLRenderingContext) CreateTexture() (w *webgl.WebGLTexture) {
...
// DeleteBuffer fn
// js:"deleteBuffer"
func (*WebGLRenderingContext) DeleteBuffer(buffer *webgl.WebGLBuffer) {
	macro.Rewrite("$_.deleteBuffer($1)", buffer)
}

// DeleteFramebuffer fn
// js:"deleteFramebuffer"
func (*WebGLRenderingContext) DeleteFramebuffer(framebuffer *webgl.WebGLFramebuffer) {
	macro.Rewrite("$_.deleteFramebuffer($1)", framebuffer)
}

// DeleteProgram fn
// js:"deleteProgram"
func (*WebGLRenderingContext) DeleteProgram(program *webgl.WebGLProgram) {
	macro.Rewrite("$_.deleteProgram($1)", program)
}

// DeleteRenderbuffer fn
// js:"deleteRenderbuffer"
func (*WebGLRenderingContext) DeleteRenderbuffer(renderbuffer *webgl.WebGLRenderbuffer) {
	macro.Rewrite("$_.deleteRenderbuffer($1)", renderbuffer)
}

// DeleteShader fn
// js:"deleteShader"
func (*WebGLRenderingContext) DeleteShader(shader *webgl.WebGLShader) {
	macro.Rewrite("$_.deleteShader($1)", shader)
}

// DeleteTexture fn
// js:"deleteTexture"
func (*WebGLRenderingContext) DeleteTexture(texture *webgl.WebGLTexture) {
...
// DetachShader fn
// js:"detachShader"
func (*WebGLRenderingContext) DetachShader(program *webgl.WebGLProgram, shader *webgl.WebGLShader) {
...
func (*WebGLRenderingContext) FramebufferRenderbuffer(target uint, attachment uint, renderbuffertarget uint, renderbuffer *webgl.WebGLRenderbuffer) {
...
func (*WebGLRenderingContext) FramebufferTexture2d(target uint, attachment uint, textarget uint, texture *webgl.WebGLTexture, level int) {
...
// GetActiveAttrib fn
// js:"getActiveAttrib"
func (*WebGLRenderingContext) GetActiveAttrib(program *webgl.WebGLProgram, index uint) (w *webgl.WebGLActiveInfo) {
...
// GetActiveUniform fn
// js:"getActiveUniform"
func (*WebGLRenderingContext) GetActiveUniform(program *webgl.WebGLProgram, index uint) (w *webgl.WebGLActiveInfo) {
...
func (*WebGLRenderingContext) GetAttachedShaders(program *webgl.WebGLProgram) (w []*webgl.WebGLShader) {
...
func (*WebGLRenderingContext) GetAttribLocation(program *webgl.WebGLProgram, name string) (i int) {
...
func (*WebGLRenderingContext) GetContextAttributes() (w *webgl.WebGLContextAttributes) {
...
func (*WebGLRenderingContext) GetProgramInfoLog(program *webgl.WebGLProgram) (s string) {
...
func (*WebGLRenderingContext) GetProgramParameter(program *webgl.WebGLProgram, pname uint) (i interface{}) {
...
// GetShaderInfoLog fn
// js:"getShaderInfoLog"
func (*WebGLRenderingContext) GetShaderInfoLog(shader *webgl.WebGLShader) (s string) {
...
func (*WebGLRenderingContext) GetShaderParameter(shader *webgl.WebGLShader, pname uint) (i interface{}) {
...
func (*WebGLRenderingContext) GetShaderPrecisionFormat(shadertype uint, precisiontype uint) (w *webgl.WebGLShaderPrecisionFormat) {
...
// GetShaderSource fn
// js:"getShaderSource"
func (*WebGLRenderingContext) GetShaderSource(shader *webgl.WebGLShader) (s string) {
...
// GetUniform fn
// js:"getUniform"
func (*WebGLRenderingContext) GetUniform(program *webgl.WebGLProgram, location *webgl.WebGLUniformLocation) (i interface{}) {
...
func (*WebGLRenderingContext) GetUniformLocation(program *webgl.WebGLProgram, name string) (w *webgl.WebGLUniformLocation) {
...
// IsBuffer fn
// js:"isBuffer"
func (*WebGLRenderingContext) IsBuffer(buffer *webgl.WebGLBuffer) (b bool) {
...
// IsFramebuffer fn
// js:"isFramebuffer"
func (*WebGLRenderingContext) IsFramebuffer(framebuffer *webgl.WebGLFramebuffer) (b bool) {
...
// IsProgram fn
// js:"isProgram"
func (*WebGLRenderingContext) IsProgram(program *webgl.WebGLProgram) (b bool) {
...
// IsRenderbuffer fn
// js:"isRenderbuffer"
func (*WebGLRenderingContext) IsRenderbuffer(renderbuffer *webgl.WebGLRenderbuffer) (b bool) {
...
// IsShader fn
// js:"isShader"
func (*WebGLRenderingContext) IsShader(shader *webgl.WebGLShader) (b bool) {
...
// IsTexture fn
// js:"isTexture"
func (*WebGLRenderingContext) IsTexture(texture *webgl.WebGLTexture) (b bool) {
...
// LinkProgram fn
// js:"linkProgram"
func (*WebGLRenderingContext) LinkProgram(program *webgl.WebGLProgram) {
...
// ShaderSource fn
// js:"shaderSource"
func (*WebGLRenderingContext) ShaderSource(shader *webgl.WebGLShader, source string) {
...
// Uniform1f fn
// js:"uniform1f"
func (*WebGLRenderingContext) Uniform1f(location *webgl.WebGLUniformLocation, x float32) {
	macro.Rewrite("$_.uniform1f($1, $2)", location, x)
}

// Uniform1fv fn
// js:"uniform1fv"
func (*WebGLRenderingContext) Uniform1fv(location *webgl.WebGLUniformLocation, v []float32) {
	macro.Rewrite("$_.uniform1fv($1, $2)", location, v)
}

// Uniform1i fn
// js:"uniform1i"
func (*WebGLRenderingContext) Uniform1i(location *webgl.WebGLUniformLocation, x int) {
	macro.Rewrite("$_.uniform1i($1, $2)", location, x)
}

// Uniform1iv fn
// js:"uniform1iv"
func (*WebGLRenderingContext) Uniform1iv(location *webgl.WebGLUniformLocation, v []int32) {
	macro.Rewrite("$_.uniform1iv($1, $2)", location, v)
}

// Uniform2f fn
// js:"uniform2f"
func (*WebGLRenderingContext) Uniform2f(location *webgl.WebGLUniformLocation, x float32, y float32) {
	macro.Rewrite("$_.uniform2f($1, $2, $3)", location, x, y)
}

// Uniform2fv fn
// js:"uniform2fv"
func (*WebGLRenderingContext) Uniform2fv(location *webgl.WebGLUniformLocation, v []float32) {
	macro.Rewrite("$_.uniform2fv($1, $2)", location, v)
}

// Uniform2i fn
// js:"uniform2i"
func (*WebGLRenderingContext) Uniform2i(location *webgl.WebGLUniformLocation, x int, y int) {
	macro.Rewrite("$_.uniform2i($1, $2, $3)", location, x, y)
}

// Uniform2iv fn
// js:"uniform2iv"
func (*WebGLRenderingContext) Uniform2iv(location *webgl.WebGLUniformLocation, v []int32) {
	macro.Rewrite("$_.uniform2iv($1, $2)", location, v)
}

// Uniform3f fn
// js:"uniform3f"
func (*WebGLRenderingContext) Uniform3f(location *webgl.WebGLUniformLocation, x float32, y float32, z float32) {
	macro.Rewrite("$_.uniform3f($1, $2, $3, $4)", location, x, y, z)
}

// Uniform3fv fn
// js:"uniform3fv"
func (*WebGLRenderingContext) Uniform3fv(location *webgl.WebGLUniformLocation, v []float32) {
	macro.Rewrite("$_.uniform3fv($1, $2)", location, v)
}

// Uniform3i fn
// js:"uniform3i"
func (*WebGLRenderingContext) Uniform3i(location *webgl.WebGLUniformLocation, x int, y int, z int) {
	macro.Rewrite("$_.uniform3i($1, $2, $3, $4)", location, x, y, z)
}

// Uniform3iv fn
// js:"uniform3iv"
func (*WebGLRenderingContext) Uniform3iv(location *webgl.WebGLUniformLocation, v []int32) {
	macro.Rewrite("$_.uniform3iv($1, $2)", location, v)
}

// Uniform4f fn
// js:"uniform4f"
func (*WebGLRenderingContext) Uniform4f(location *webgl.WebGLUniformLocation, x float32, y float32, z float32, w float32) {
	macro.Rewrite("$_.uniform4f($1, $2, $3, $4, $5)", location, x, y, z, w)
}

// Uniform4fv fn
// js:"uniform4fv"
func (*WebGLRenderingContext) Uniform4fv(location *webgl.WebGLUniformLocation, v []float32) {
	macro.Rewrite("$_.uniform4fv($1, $2)", location, v)
}

// Uniform4i fn
// js:"uniform4i"
func (*WebGLRenderingContext) Uniform4i(location *webgl.WebGLUniformLocation, x int, y int, z int, w int) {
	macro.Rewrite("$_.uniform4i($1, $2, $3, $4, $5)", location, x, y, z, w)
}

// Uniform4iv fn
// js:"uniform4iv"
func (*WebGLRenderingContext) Uniform4iv(location *webgl.WebGLUniformLocation, v []int32) {
	macro.Rewrite("$_.uniform4iv($1, $2)", location, v)
}

// UniformMatrix2fv fn
// js:"uniformMatrix2fv"
func (*WebGLRenderingContext) UniformMatrix2fv(location *webgl.WebGLUniformLocation, transpose bool, value []float32) {
	macro.Rewrite("$_.uniformMatrix2fv($1, $2, $3)", location, transpose, value)
}

// UniformMatrix3fv fn
// js:"uniformMatrix3fv"
func (*WebGLRenderingContext) UniformMatrix3fv(location *webgl.WebGLUniformLocation, transpose bool, value []float32) {
	macro.Rewrite("$_.uniformMatrix3fv($1, $2, $3)", location, transpose, value)
}

// UniformMatrix4fv fn
// js:"uniformMatrix4fv"
func (*WebGLRenderingContext) UniformMatrix4fv(location *webgl.WebGLUniformLocation, transpose bool, value []float32) {
	macro.Rewrite("$_.uniformMatrix4fv($1, $2, $3)", location, transpose, value)
}

// UseProgram fn
// js:"useProgram"
func (*WebGLRenderingContext) UseProgram(program *webgl.WebGLProgram) {
	macro.Rewrite("$_.useProgram($1)", program)
}

// ValidateProgram fn
// js:"validateProgram"
func (*WebGLRenderingContext) ValidateProgram(program *webgl.WebGLProgram) {
