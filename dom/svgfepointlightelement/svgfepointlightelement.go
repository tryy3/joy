...
var _ dom.ChildNode = (*SVGFEPointLightElement)(nil)
...
func (*SVGFEPointLightElement) GetBoundingClientRect() (d *dom.ClientRect) {
...
// GetClientRects fn
// js:"getClientRects"
func (*SVGFEPointLightElement) GetClientRects() (d *dom.ClientRectList) {
...
func (*SVGFEPointLightElement) MsGetUntransformedBounds() (d *dom.ClientRect) {
...
// X prop
// js:"x"
func (*SVGFEPointLightElement) X() (x *dom.SVGAnimatedNumber) {
	macro.Rewrite("$_.x")
	return x
}
...
// Y prop
// js:"y"
func (*SVGFEPointLightElement) Y() (y *dom.SVGAnimatedNumber) {
	macro.Rewrite("$_.y")
	return y
}
...
// Z prop
// js:"z"
func (*SVGFEPointLightElement) Z() (z *dom.SVGAnimatedNumber) {
	macro.Rewrite("$_.z")
	return z
}
...
// Dataset prop
// js:"dataset"
func (*SVGFEPointLightElement) Dataset() (dataset *dom.DOMStringMap) {
...
// ClassList prop
// js:"classList"
func (*SVGFEPointLightElement) ClassList() (classList dom.DOMTokenList) {
